...
namespace StoneShelter{
    ...
    public class GUID : MonoBehaviour{
		...
		protected void Reset(){
            #region prefab
#if UNITY_EDITOR
			if(UnityEditor.SceneManagement.PrefabStageUtility.GetCurrentPrefabStage() != null || PrefabUtility.IsPartOfPrefabAsset(this)){
...
#region prefab + editor
        ...
        public void PrefabUpdateLinkedInstancesGUID(){
            ...
            if(UnityEditor.SceneManagement.PrefabStageUtility.GetCurrentPrefabStage() != null)
                assetPath = UnityEditor.SceneManagement.PrefabStageUtility.GetCurrentPrefabStage().assetPath;
